...
//         });
//         oneInchSupportedTokens = result.tokens;
//         let parent = document.getElementById("token_list");
//
//         //Creates a new div for each token returned.
//         for (const address in oneInchSupportedTokens) {
//             let token = oneInchSupportedTokens[address];
...
//             console.log("Using from token: " + oneInchSupportedTokens[address].name);
//             if (currentSelectSide == 'from') {
//                 fromToken = oneInchSupportedTokens[address];
//             }
//             if (currentSelectSide == 'to') {
//                 toToken = oneInchSupportedTokens[address];
//             }
//             renderInterface();
//             getQuote();
//         }
